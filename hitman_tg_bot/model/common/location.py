...
class Location:
    ...
    def __init__(self, name, connetcted_locations, disguise, witnesses, items, path, unlocked=False):
        self.name = name
    ...
    def unlock(self, update: Update, context: CallbackContext):
        ...
        self.unlocked = True
        context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('hitman_tg_bot/assets/' + self.path, 'rb'), timeout=1000)
