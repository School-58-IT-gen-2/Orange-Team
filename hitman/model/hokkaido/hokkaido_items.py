from hitman.model.common.item import Item
...
# combat_knife = Item('Боевой нож', ['Бросить (летально)', 'Ударить (летально)', 'Отменить действие'], True, True)
#
# hokkaido_disguises = {
#     1: 'VIP - пациент',
#     2: 'Охранник',
...
# ]
#
# def hokkaido_item_by_name(item_name):
#     item_names = {
